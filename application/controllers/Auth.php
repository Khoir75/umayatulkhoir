...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert_success" role="alert">Congratulation!your account has been created. please activate your account</div>');
            redirect('auth');
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'umayatul363@gmail.com';
        $config['smtp_pass'] = 'lbovtrqdpjwnmhzg';
        ...
        $this->email->from('umayatul363@gmail.com', 'Web Programing SMKN8Jember');
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('password1', 'password', 'trim|required|min_length[5]|matches[password1]');
        $this->form_validation->set_rules('password2', 'Repeat password', 'trim|required|min_length[5]|matches[password2]');
        if ($this->form_validation->run() == false) {
